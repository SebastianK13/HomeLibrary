intellisense.annotate(jQuery, {
  ...
  'each': function() {
    ...
    ///   <param name="FormCollection" type="Object">The object or array to iterate over.</param>
  ...
  'support': function() {
    /// <summary>A FormCollection of properties that represent the presence of different browser features or bugs. Primarily intended for jQuery's internal use; specific properties may be removed when they are no longer needed internally to improve page startup performance.</summary>
    /// <returns type="Object" />
  },
  'trim': function() {
    /// <signature>
...
intellisense.annotate(_object, {
  'add': function() {
    /// <signature>
    ///   <summary>Add a callback or a FormCollection of callbacks to a callback list.</summary>
  ...
  'remove': function() {
    /// <signature>
    ///   <summary>Remove a callback or a FormCollection of callbacks from a callback list.</summary>
...
intellisense.annotate(jQuery.fn, {
  ...
  'index': function() {
    ...
    ///   <param name="selector" type="String">A selector representing a jQuery FormCollection in which to look for an element.</param>
    ///   <returns type="Number" />
    /// </signature>
    /// <signature>
    ///   <summary>Search for a given element from among the matched elements.</summary>
  ...
  'is': function() {
    ...
    /// <signature>
    ///   <summary>Check the current matched set of elements against a selector, element, or jQuery object and return true if at least one of these elements matches the given arguments.</summary>
    ///   <param name="function(index)" type="Function">A function used as a test for the set of elements. It accepts one argument, index, which is the element's index in the jQuery FormCollection.Within the function, this refers to the current DOM element.</param>
    ///   <returns type="Boolean" />
    /// </signature>
    /// <signature>
    ///   <summary>Check the current matched set of elements against a selector, element, or jQuery object and return true if at least one of these elements matches the given arguments.</summary>
  ...
  'offset': function() {
    ...
    /// <signature>
    ///   <summary>Set the current coordinates of every element in the set of matched elements, relative to the document.</summary>
    ///   <param name="function(index, coords)" type="Function">A function to return the coordinates to set. Receives the index of the element in the FormCollection as the first argument and the current coordinates as the second argument. The function should return an object with the new top and left properties.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  ...
  'promise': function() {
    /// <signature>
    ///   <summary>Return a Promise object to observe when all actions of a certain type bound to the FormCollection, queued or not, have finished.</summary>
  ...
  'pushStack': function() {
    /// <signature>
    ///   <summary>Add a FormCollection of DOM elements onto the jQuery stack.</summary>
